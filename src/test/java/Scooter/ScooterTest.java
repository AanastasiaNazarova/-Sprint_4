...
public class ScooterTest extends BaseUITest {
    private final String buttonQuestion;
    private final String panelАnswer;
    private final String expected;

    public ScooterTest(String buttonQuestion, String panelАnswer, String expected) {
        this.buttonQuestion = buttonQuestion;
        this.panelАnswer = panelАnswer;
    ...
    @Test
    public void checkTestWhenClickButtonWithQuestion() {
        driver.get(MainPage.URL);
        MainPage mainPage = new MainPage(driver);
        mainPage.clickButtonQuestion(buttonQuestion,panelАnswer);
        String actual = mainPage.getTextFromPanelАnswer(panelАnswer);
